...
@section('konten')
    ...
    <div class="card shadow-lg">
        <div class="card-body">
                    <h4 class="card-title">Edit Data Bus & Elf</h4>
                    <form class="form-sample" action="{{url('bus/'.$bus->id)}}" method="POST">
                    @csrf @method('PATCH')
                        <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="no_pol" value="{{ $bus->no_pol }}"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="max_isi" value="{{ $bus->max_pengisian }}"/>
