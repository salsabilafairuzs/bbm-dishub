...
@section('konten')
    ...
    <div class="card shadow-lg">
        <div class="card-body">
                    <h4 class="card-title">Edit Data Roda 2</h4>
                    <form class="form-sample" action="{{url('rodadua/'.$rodadua->id)}}" method="POST">
                    @csrf @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" value="{{ $rodadua->name }}"/>
                                    @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="max_isi" value="{{ $rodadua->max_pengisian }}"/>
                        ...
                        <a href="/rodadua" class="btn btn-light">Cancel</a>
                    </form>
                    </div>
        </div>
    </div>
