...
@section('konten')
    <div class="content-wrapper">
        <div class="card shadow-lg">
            <div class="card-body">
                <div class="row">
                <h4 class="card-title" style="margin-left:20px">Data Transaksi Perlengkapan</h4>
                    <div class="col-md-12">
                        <a href="{{url('/transaksi4/create')}}" class="btn btn-primary btn-md" style="margin-right:40px; margin-top:5px; margin-bottom:10px; padding:10px; border-radius:7px;"><i class="fas fa-plus" style="margin-right:10px;"></i>Tambah</a>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('buktiTransaksi4/' . $item->bukti_pembayaran) }}" width="90px" height="78%" style="border-radius: 1px;"></td>
                            <td>
                                <a class="btn btn-warning btn-sm" style="border-radius:4px;"  onclick="detailForm({{ $item->id }})"><i class="fas fa-info"></i></a>
                                <a class="btn btn-success btn-sm" style="border-radius:4px;"  href="{{ url('transaksi4/'.$item->id.'/edit')}}"><i class="fas fa-pencil-alt"></i></a>
                                <a class="btn btn-danger btn-sm" style="border-radius:4px;"  onclick="return confirm('Apakah anda yakin ingin menghapusnya?')?true:false" href="{{ url('transaksi4-hapus/'.$item->id)}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
